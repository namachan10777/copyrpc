...
図\ref{fig:benchkv-batch-hold}および表\ref{tab:benchkv-batch-hold}に，提案方式におけるAdaptive Batch Holdの有無を比較した結果を示す．

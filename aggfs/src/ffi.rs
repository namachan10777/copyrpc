//! C FFI for libaggfs — used by IOR AIORI plugin.
...
/// aggfsd server.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_connect(
...
///
/// # Safety
/// `client` must be a valid pointer returned by `aggfs_connect`, and must
/// not be used after this call.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_disconnect(client: *mut FsClient) {
    if !client.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_create(
    client: *mut FsClient,
    path: *const c_char,
    mode: u32,
) -> i32 {
...
/// `client` must be a valid pointer. `path` must be null-terminated.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_open(client: *mut FsClient, path: *const c_char) -> i64 {
    let client = unsafe { &mut *client };
    let path = unsafe { CStr::from_ptr(path) };
    let Ok(path_str) = path.to_str() else {
        return -1;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_close(client: *mut FsClient, fd: u32) -> i32 {
    let client = unsafe { &mut *client };
    match client.close(fd) {
        Ok(()) => 0,
        Err(e) => {
            eprintln!("aggfs_close: {}", e);
            -libc::EBADF
        }
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_pwrite(
    client: *mut FsClient,
    fd: u32,
    buf: *const u8,
    len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_pread(
    client: *mut FsClient,
    fd: u32,
    buf: *mut u8,
    len: usize,
...
/// a valid pointer.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_stat(
    client: *mut FsClient,
    path: *const c_char,
    size_out: *mut u64,
) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aggfs_unlink(client: *mut FsClient, path: *const c_char) -> i32 {
    let client = unsafe { &mut *client };
    let path = unsafe { CStr::from_ptr(path) };
    let Ok(path_str) = path.to_str() else {
        return -libc::EINVAL;
